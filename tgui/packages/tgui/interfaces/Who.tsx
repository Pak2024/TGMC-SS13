...
type Data = {
  ...
  player_additional?: { total_players: Record<string, PlayerPayload>[] };
  player_stealthed_additional?: {
    total_players: Record<string, PlayerPayload>[];
  };
...
const FilterPlayers = (props: {
  players_to_filter: Record<string, PlayerPayload[]>[];
}) => {
...
const isMatch = (playerObj, searchQuery: string) => {
  if (!searchQuery) {
    return true;
  }
